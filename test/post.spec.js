...
describe('post', () => {
    ...
    context('quando eu cadastro uma tarefa', () => {
        let task = 
            { title: 'Estudar Mongoose', owner: 'eu@papito.io', done: false }
    ...
    context('quando nao informo o titulo', () => {
        let task = 
            { title: '', owner: 'eu@papito.io', done: false }
    ...
    context('quando nao informo o dono', () => {
        let task = 
            { title: 'Nova tarefa', owner: '', done: false }
    ...
    context('quando a tarefa já existe', () => {
        let task = 
            { title: 'Planejar viagem para a China', owner: 'eu@papito.io', done: false }
